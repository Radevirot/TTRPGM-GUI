...
Ventana_principal::Ventana_principal( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText66 = new wxStaticText( this, wxID_ANY, wxT("¡Bienvenido a la aplicación de\n gestión de juegos de rol!"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTER_HORIZONTAL );
...
Ventana_partida::Ventana_partida( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_Guardar = new wxMenuItem( m_menu1, wxID_ANY, wxString( wxT("Guardar") ) + wxT('\t') + wxT("Ctrl+G"), wxEmptyString, wxITEM_NORMAL );
	#ifdef __WXMSW__
	m_Guardar->SetBitmaps( wxBitmap( wxT("imagenes/guardar.bmp"), wxBITMAP_TYPE_ANY ) );
	#elif (defined( __WXGTK__ ) || defined( __WXOSX__ ))
	m_Guardar->SetBitmap( wxBitmap( wxT("imagenes/guardar.bmp"), wxBITMAP_TYPE_ANY ) );
	#endif
	m_menu1->Append( m_Guardar );

	wxMenuItem* m_Cargar;
	m_Cargar = new wxMenuItem( m_menu1, wxID_ANY, wxString( wxT("Cargar") ) + wxT('\t') + wxT("Ctrl+A"), wxEmptyString, wxITEM_NORMAL );
	#ifdef __WXMSW__
	m_Cargar->SetBitmaps( wxBitmap( wxT("imagenes/cargar.bmp"), wxBITMAP_TYPE_ANY ) );
	#elif (defined( __WXGTK__ ) || defined( __WXOSX__ ))
	m_Cargar->SetBitmap( wxBitmap( wxT("imagenes/cargar.bmp"), wxBITMAP_TYPE_ANY ) );
	#endif
	m_menu1->Append( m_Cargar );

	wxMenuItem* m_EditarNom;
	m_EditarNom = new wxMenuItem( m_menu1, wxID_ANY, wxString( wxT("Renombrar") ) + wxT('\t') + wxT("Ctrl+R"), wxEmptyString, wxITEM_NORMAL );
	#ifdef __WXMSW__
	m_EditarNom->SetBitmaps( wxBitmap( wxT("imagenes/renombrar.bmp"), wxBITMAP_TYPE_ANY ) );
	#elif (defined( __WXGTK__ ) || defined( __WXOSX__ ))
	m_EditarNom->SetBitmap( wxBitmap( wxT("imagenes/renombrar.bmp"), wxBITMAP_TYPE_ANY ) );
	#endif
	m_menu1->Append( m_EditarNom );

	wxMenuItem* m_Nueva;
	m_Nueva = new wxMenuItem( m_menu1, wxID_ANY, wxString( wxT("Nueva") ) + wxT('\t') + wxT("Ctrl+N"), wxEmptyString, wxITEM_NORMAL );
	#ifdef __WXMSW__
	m_Nueva->SetBitmaps( wxBitmap( wxT("imagenes/Nueva.bmp"), wxBITMAP_TYPE_ANY ) );
	#elif (defined( __WXGTK__ ) || defined( __WXOSX__ ))
	m_Nueva->SetBitmap( wxBitmap( wxT("imagenes/Nueva.bmp"), wxBITMAP_TYPE_ANY ) );
	#endif
	m_menu1->Append( m_Nueva );

	m_menu1->AppendSeparator();

	wxMenuItem* m_Ayuda;
	m_Ayuda = new wxMenuItem( m_menu1, wxID_ANY, wxString( wxT("Ayuda") ) + wxT('\t') + wxT("F2"), wxEmptyString, wxITEM_NORMAL );
	#ifdef __WXMSW__
	m_Ayuda->SetBitmaps( wxBitmap( wxT("imagenes/ayuda.bmp"), wxBITMAP_TYPE_ANY ) );
	#elif (defined( __WXGTK__ ) || defined( __WXOSX__ ))
	m_Ayuda->SetBitmap( wxBitmap( wxT("imagenes/ayuda.bmp"), wxBITMAP_TYPE_ANY ) );
	#endif
	...
	m_Combate = m_toolBar4->AddTool( wxID_ANY, wxT("tool"), wxBitmap( wxT("imagenes/combate.bmp"), wxBITMAP_TYPE_ANY ), wxNullBitmap, wxITEM_NORMAL, wxT("Simulación de ataque (Ctrl+1)"), wxEmptyString, NULL );

	m_Dado = m_toolBar4->AddTool( wxID_ANY, wxT("tool"), wxBitmap( wxT("imagenes/dado.bmp"), wxBITMAP_TYPE_ANY ), wxNullBitmap, wxITEM_NORMAL, wxT("Dado virtual (Ctrl+2)"), wxEmptyString, NULL );
	...
	m_AgregarIPers = new wxButton( this, wxID_ANY, wxT("Agregar item"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer58->Add( m_AgregarIPers, 0, wxALL|wxEXPAND, 5 );
	...
	m_AgregarIPers->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( Ventana_partida::OnClickVerInventario ), NULL, this );
...
Ventana_partida::~Ventana_partida()
{
	...
	m_AgregarIPers->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( Ventana_partida::OnClickVerInventario ), NULL, this );
...
Ventana_personaje::Ventana_personaje( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_PVt = new wxStaticText( this, wxID_ANY, wxT("0"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTER_HORIZONTAL|wxST_NO_AUTORESIZE );
	m_PVt->Wrap( -1 );
	bSizer48->Add( m_PVt, 0, wxALL|wxEXPAND, 5 );
	...
	m_DFNt = new wxStaticText( this, wxID_ANY, wxT("0"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTER_HORIZONTAL|wxST_NO_AUTORESIZE );
	m_DFNt->Wrap( -1 );
	bSizer481->Add( m_DFNt, 0, wxALL|wxEXPAND, 5 );
	...
	m_FRZt = new wxStaticText( this, wxID_ANY, wxT("0"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTER_HORIZONTAL|wxST_NO_AUTORESIZE );
	m_FRZt->Wrap( -1 );
	bSizer482->Add( m_FRZt, 0, wxALL|wxEXPAND, 5 );
	...
	m_AGLt = new wxStaticText( this, wxID_ANY, wxT("0"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTER_HORIZONTAL|wxST_NO_AUTORESIZE );
	m_AGLt->Wrap( -1 );
	bSizer483->Add( m_AGLt, 0, wxALL|wxEXPAND, 5 );
	...
	m_RMt = new wxStaticText( this, wxID_ANY, wxT("0"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTER_HORIZONTAL|wxST_NO_AUTORESIZE );
	m_RMt->Wrap( -1 );
	bSizer484->Add( m_RMt, 0, wxALL|wxEXPAND, 5 );
	...
	m_INTt = new wxStaticText( this, wxID_ANY, wxT("0"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTER_HORIZONTAL|wxST_NO_AUTORESIZE );
	m_INTt->Wrap( -1 );
	bSizer485->Add( m_INTt, 0, wxALL|wxEXPAND, 5 );
	...
	m_MNt = new wxStaticText( this, wxID_ANY, wxT("0"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTER_HORIZONTAL|wxST_NO_AUTORESIZE );
	m_MNt->Wrap( -1 );
	bSizer486->Add( m_MNt, 0, wxALL|wxEXPAND, 5 );
	...
	// Connect Events
	this->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ) );
	m_Personajename->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_Nombre->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_asda->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_Nivel->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_sdad->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_EXP->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_EXP->Connect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Ventana_personaje::OnRueditaEXP ), NULL, this );
	m_staticText94->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_staticText93->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_staticText8->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_PVb->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_PVb->Connect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Ventana_personaje::OnRueditaVida ), NULL, this );
	...
	m_PVt->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_staticText81->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_DFNb->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_DFNb->Connect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Ventana_personaje::OnRueditaDef ), NULL, this );
	...
	m_DFNt->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_staticText82->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_FRZb->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_FRZb->Connect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Ventana_personaje::OnRueditaFuerza ), NULL, this );
	...
	m_FRZt->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_staticText83->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_AGLb->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_AGLb->Connect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Ventana_personaje::OnRueditaAgi ), NULL, this );
	...
	m_AGLt->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_staticText84->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_RMb->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_RMb->Connect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Ventana_personaje::OnRueditaResM ), NULL, this );
	...
	m_RMt->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_staticText85->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_INTb->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_INTb->Connect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Ventana_personaje::OnRueditaInte ), NULL, this );
	...
	m_INTt->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_staticText86->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_MNb->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_MNb->Connect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Ventana_personaje::OnRueditaMana ), NULL, this );
	...
	m_MNt->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_staticText87->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_DN->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_staticText871->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_RNG->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_staticText8721->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_PNT->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_staticText872->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_BLQ->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_staticline4->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_Detalle->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_staticline411->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_aplicarcambios->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( Ventana_personaje::OnClickAplicar ), NULL, this );
	m_aplicarcambios->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_button4->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( Ventana_personaje::OnClickExportar ), NULL, this );
	m_button4->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_staticText32->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	...
	m_Inventario->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_button6->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( Ventana_personaje::OnClickAgregar ), NULL, this );
	m_button6->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_button34->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( Ventana_personaje::OnClickBorrar ), NULL, this );
	m_button34->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
}

Ventana_personaje::~Ventana_personaje()
{
	// Disconnect Events
	this->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ) );
	m_Personajename->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_Nombre->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_asda->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_Nivel->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_sdad->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_EXP->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_EXP->Disconnect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Ventana_personaje::OnRueditaEXP ), NULL, this );
	m_staticText94->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_staticText93->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_staticText8->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_PVb->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_PVb->Disconnect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Ventana_personaje::OnRueditaVida ), NULL, this );
	...
	m_PVt->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_staticText81->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_DFNb->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_DFNb->Disconnect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Ventana_personaje::OnRueditaDef ), NULL, this );
	...
	m_DFNt->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_staticText82->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_FRZb->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_FRZb->Disconnect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Ventana_personaje::OnRueditaFuerza ), NULL, this );
	...
	m_FRZt->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_staticText83->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_AGLb->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_AGLb->Disconnect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Ventana_personaje::OnRueditaAgi ), NULL, this );
	...
	m_AGLt->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_staticText84->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_RMb->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_RMb->Disconnect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Ventana_personaje::OnRueditaResM ), NULL, this );
	...
	m_RMt->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_staticText85->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_INTb->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_INTb->Disconnect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Ventana_personaje::OnRueditaInte ), NULL, this );
	...
	m_INTt->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_staticText86->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_MNb->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_MNb->Disconnect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Ventana_personaje::OnRueditaMana ), NULL, this );
	...
	m_MNt->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_staticText87->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_DN->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_staticText871->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_RNG->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_staticText8721->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_PNT->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_staticText872->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_BLQ->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_staticline4->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_Detalle->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_staticline411->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	...
	m_aplicarcambios->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_button4->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( Ventana_personaje::OnClickExportar ), NULL, this );
	m_button4->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_staticText32->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	...
	m_Inventario->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_button6->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( Ventana_personaje::OnClickAgregar ), NULL, this );
	m_button6->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
	m_button34->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( Ventana_personaje::OnClickBorrar ), NULL, this );
	m_button34->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_personaje::OnApretarTecla ), NULL, this );
...
Ventana_item::Ventana_item( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	// Connect Events
	this->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ) );
	m_Personajename->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_NombreItem->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_button7->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( Ventana_item::OnClickAplicar ), NULL, this );
	m_button7->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_button4->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( Ventana_item::OnClickExportar ), NULL, this );
	m_button4->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_Nivel->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_Cantidad->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_staticText94->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_staticText875->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	...
	m_Rango->Connect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Ventana_item::OnRueditaRango ), NULL, this );
	m_staticText8721->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_Punteria->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_Punteria->Connect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Ventana_item::OnRueditaPunt ), NULL, this );
	m_staticText872->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_Bloqueo->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_Bloqueo->Connect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Ventana_item::OnRueditaBloq ), NULL, this );
	m_staticText81->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_Defenza->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_Defenza->Connect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Ventana_item::OnRueditaDef ), NULL, this );
	m_staticText84->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_ResistenciaMagica->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_ResistenciaMagica->Connect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Ventana_item::OnRueditaResM ), NULL, this );
	m_staticText8->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_PuntosVida->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_PuntosVida->Connect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Ventana_item::OnRueditaVida ), NULL, this );
	m_staticText82->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_Fuerza->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_Fuerza->Connect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Ventana_item::OnRueditaFuerza ), NULL, this );
	m_staticText83->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_Agilidad->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_Agilidad->Connect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Ventana_item::OnRueditaAgi ), NULL, this );
	m_staticText85->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_Inteligencia->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_Inteligencia->Connect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Ventana_item::OnRueditaInte ), NULL, this );
	m_staticText86->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_Mana->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_Mana->Connect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Ventana_item::OnRueditaMana ), NULL, this );
	m_staticText43->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_Detalle->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_staticText431->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_Descripcion->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
}

Ventana_item::~Ventana_item()
{
	// Disconnect Events
	this->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ) );
	m_Personajename->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_NombreItem->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_button7->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( Ventana_item::OnClickAplicar ), NULL, this );
	m_button7->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_button4->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( Ventana_item::OnClickExportar ), NULL, this );
	m_button4->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_Nivel->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_Cantidad->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_staticText94->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_staticText875->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	...
	m_Rango->Disconnect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Ventana_item::OnRueditaRango ), NULL, this );
	m_staticText8721->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_Punteria->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_Punteria->Disconnect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Ventana_item::OnRueditaPunt ), NULL, this );
	m_staticText872->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_Bloqueo->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_Bloqueo->Disconnect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Ventana_item::OnRueditaBloq ), NULL, this );
	m_staticText81->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_Defenza->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_Defenza->Disconnect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Ventana_item::OnRueditaDef ), NULL, this );
	m_staticText84->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_ResistenciaMagica->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_ResistenciaMagica->Disconnect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Ventana_item::OnRueditaResM ), NULL, this );
	m_staticText8->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_PuntosVida->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_PuntosVida->Disconnect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Ventana_item::OnRueditaVida ), NULL, this );
	m_staticText82->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_Fuerza->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_Fuerza->Disconnect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Ventana_item::OnRueditaFuerza ), NULL, this );
	m_staticText83->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_Agilidad->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_Agilidad->Disconnect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Ventana_item::OnRueditaAgi ), NULL, this );
	m_staticText85->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_Inteligencia->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_Inteligencia->Disconnect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Ventana_item::OnRueditaInte ), NULL, this );
	m_staticText86->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_Mana->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_Mana->Disconnect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Ventana_item::OnRueditaMana ), NULL, this );
	m_staticText43->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_Detalle->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_staticText431->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
	m_Descripcion->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_item::OnApretarTecla ), NULL, this );
...
Ventana_dados::Ventana_dados( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_staticText10 = new wxStaticText( this, wxID_ANY, wxT("Creación de dados"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	bSizer188->Add( m_staticText10, 0, wxALIGN_CENTER|wxALL, 5 );
	...
	m_staticText10->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_dados::OnApretarTecla ), NULL, this );
...
Ventana_dados::~Ventana_dados()
{
	...
	m_staticText10->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Ventana_dados::OnApretarTecla ), NULL, this );
...
Dialogo_Personaje::Dialogo_Personaje( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	// Connect Events
	this->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ) );
	m_Personajename->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_Nombre->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_asda->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_Nivel->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_sdad->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_EXP->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_EXP->Connect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Dialogo_Personaje::OnRueditaEXP ), NULL, this );
	m_staticline41->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_staticText94->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_staticText93->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_staticText8->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_PVb->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_PVb->Connect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Dialogo_Personaje::OnRueditaVida ), NULL, this );
	...
	m_PVt->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_staticText81->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_DFNb->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_DFNb->Connect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Dialogo_Personaje::OnRueditaDef ), NULL, this );
	...
	m_DFNt->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_staticText82->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_FRZb->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_FRZb->Connect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Dialogo_Personaje::OnRueditaFuerza ), NULL, this );
	...
	m_FRZt->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_staticText83->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_AGLb->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_AGLb->Connect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Dialogo_Personaje::OnRueditaAgi ), NULL, this );
	...
	m_AGLt->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_staticText84->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_RMb->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_RMb->Connect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Dialogo_Personaje::OnRueditaResM ), NULL, this );
	...
	m_RMt->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_staticText85->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_INTb->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_INTb->Connect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Dialogo_Personaje::OnRueditaInte ), NULL, this );
	...
	m_INTt->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_staticText86->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_MNb->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_MNb->Connect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Dialogo_Personaje::OnRueditaMana ), NULL, this );
	...
	m_MNt->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_staticText87->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_DN->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_staticText871->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_RNG->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_staticText8721->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_PNT->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_staticText872->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_BLQ->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_staticline4->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_staticText43->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_Detalle->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_staticline411->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_aplicarcambios->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( Dialogo_Personaje::OnClickAplicar ), NULL, this );
	m_aplicarcambios->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_button4->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( Dialogo_Personaje::OnClickExportar ), NULL, this );
	m_button4->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_staticText32->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	...
	m_Inventario->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_button6->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( Dialogo_Personaje::OnClickAgregar ), NULL, this );
	m_button6->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_button34->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( Dialogo_Personaje::OnClickBorrar ), NULL, this );
	m_button34->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
}

Dialogo_Personaje::~Dialogo_Personaje()
{
	// Disconnect Events
	this->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ) );
	m_Personajename->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_Nombre->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_asda->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_Nivel->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_sdad->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_EXP->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_EXP->Disconnect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Dialogo_Personaje::OnRueditaEXP ), NULL, this );
	m_staticline41->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_staticText94->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_staticText93->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_staticText8->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_PVb->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_PVb->Disconnect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Dialogo_Personaje::OnRueditaVida ), NULL, this );
	...
	m_PVt->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_staticText81->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_DFNb->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_DFNb->Disconnect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Dialogo_Personaje::OnRueditaDef ), NULL, this );
	...
	m_DFNt->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_staticText82->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_FRZb->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_FRZb->Disconnect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Dialogo_Personaje::OnRueditaFuerza ), NULL, this );
	...
	m_FRZt->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_staticText83->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_AGLb->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_AGLb->Disconnect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Dialogo_Personaje::OnRueditaAgi ), NULL, this );
	...
	m_AGLt->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_staticText84->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_RMb->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_RMb->Disconnect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Dialogo_Personaje::OnRueditaResM ), NULL, this );
	...
	m_RMt->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_staticText85->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_INTb->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_INTb->Disconnect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Dialogo_Personaje::OnRueditaInte ), NULL, this );
	...
	m_INTt->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_staticText86->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_MNb->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_MNb->Disconnect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( Dialogo_Personaje::OnRueditaMana ), NULL, this );
	...
	m_MNt->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_staticText87->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_DN->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_staticText871->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_RNG->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_staticText8721->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_PNT->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_staticText872->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_BLQ->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_staticline4->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_staticText43->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_Detalle->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_staticline411->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	...
	m_aplicarcambios->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_button4->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( Dialogo_Personaje::OnClickExportar ), NULL, this );
	m_button4->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_staticText32->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	...
	m_Inventario->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_button6->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( Dialogo_Personaje::OnClickAgregar ), NULL, this );
	m_button6->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
	m_button34->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( Dialogo_Personaje::OnClickBorrar ), NULL, this );
	m_button34->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Dialogo_Personaje::OnApretarTecla ), NULL, this );
